...
export function DayCell({
  ...
  if (isLoading) {
    return (
      <div className="min-h-[140px] bg-white/20 p-3">
      ...
      <Tooltip delayDuration={200}>
        <TooltipTrigger asChild>
          <motion.div
            ...
            onClick={onClick}
            className={`
              min-h-[140px] p-3 cursor-pointer transition-all relative
              ${isCurrentMonth ? "bg-white/30" : "bg-gray-50/20"}
              ${isToday ? "ring-2 ring-blue-400" : ""}
              hover:bg-gradient-to-br hover:from-blue-50 hover:to-indigo-50/30
            `}
          >
            <div className={`
            ...
            <div className="space-y-1.5">
                ...
                <motion.div
                  ...
                  className={`
                    ...
                    ${event.workType === "office"
                      ? "bg-gradient-to-r from-blue-100/60 to-blue-50/60 text-blue-700"
                      : "bg-gradient-to-r from-green-100/60 to-green-50/60 text-green-700"
                    }
                  `}
                >
                  {event.workType === "office" ? (
              ...
              {attendance && (
                <div className="flex items-center gap-1.5 text-xs text-gray-600 bg-gradient-to-r from-gray-100/60 to-gray-50/60 p-1.5 rounded-lg">
              ...
              {tasks.length > 0 && (
                <div className="text-xs font-medium text-purple-700 bg-gradient-to-r from-purple-100/60 to-purple-50/60 p-1.5 rounded-lg">
                  {tasks.length} タスク
                </div>
              )}
            </div>
